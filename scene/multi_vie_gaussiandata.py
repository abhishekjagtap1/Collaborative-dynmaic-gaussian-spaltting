...
class Neural3D_NDC_Dataset(Dataset):
    ...
    def load_meta(self, datadir):
        ...
        self.image_paths, self.image_poses, self.image_times, self.depth_paths, self.flow_paths = self.load_images_path(
            datadir, self.split)
    ...
    def load_images_path(self, datadir, split):
                ...
                if dir == "cam01":  # South 2
                    ...
                    for img_file in image_files:
                        ...
                        image_pose_dict = {
                            ...
                            # novel_views[img_index], #novel_views[img_index], #new_extrinsic_up, #update_inter, #extrinsic_south_2, #, # update_extrinsics, # #novel_poses[img_index], # #extrinsic_south_2, #
                ...
                if dir == "cam03":  # South 1
                    ...
                    for img_file in image_files:
                        ...
                        image_pose_dict = {
                            ...
                            # novel_views[img_index], #new_extrinsic_up, #camera_to_lidar_extrinsics_south_1, #extrinsic_south_1, #c
        ...
        return image_paths, image_poses, image_times, depth_paths, flow_paths  # Use this for training gaussian spalatting on TUMTRAF image_poses,

...
September 2 --> CVPR Bencmarking Time

If i Dont do it now, i am not capable of PhD 
...
class Neural3D_NDC_Dataset(Dataset):
                ...
                if dir == "cam01":  # South 2
                    ...
                    for img_file in image_files:
                        ...
                        image_pose_dict = {
                            ...
                            # new_extrinsic_up, #update_inter,#extrinsic_south_2, #new_extrinsic_up, #new_extrinsic_up, #update_rotating_extrinsics, #novel_poses_per_image, #update_rotating_extrinsics,  #update_inter, # update_extrinsics, # #novel_poses[img_index], # #
                ...
                if dir == "cam02":
                    ...
                    for img_file, meta_file in zip(image_files, meta_files):
                        ...
                        image_pose_dict = {
                            ...
                            # update_inter_veh, #extrinsic_v, #update_extrinsics_ve, #  , novel_poses_vehicle[img_index], # #
                ...
                if dir == "cam08":  # South 1
                    ...
                    for img_file in image_files:
                        ...
                        image_pose_dict = {
                            ...
                            # new_extrinsic_up, #s2_update_rotating_extrinsics, #camera_to_lidar_extrinsics_south_1,
    ...
    def __getitem__(self, index):
        ...
        if self.semantic_data:
            sam_masks = torch.load(self.semantic_paths[index]) if self.semantic_data is not None else None
            # shata = none

        return img, self.image_poses[index], self.image_times[index], depth, optical_flow_mask, sam_masks
